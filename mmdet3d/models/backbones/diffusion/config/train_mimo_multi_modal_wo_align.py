...
Date: 2024-02-22 00:36:13
Email: haimingzhang@link.cuhk.edu.cn
Description: Train the occworld with multi-modal inputs and 
predict future images. But without feature alignments.
'''
grad_max_norm = 35
print_freq = 10
max_epochs = 200
...
n_e_ = 512
model = dict(
    type='MultiModalPredictorWithRender',
    debug=False,
    use_predictor=True,
