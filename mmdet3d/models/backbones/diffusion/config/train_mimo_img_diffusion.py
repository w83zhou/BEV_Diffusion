...
Date: 2024-02-29 11:49:17
Email: haimingzhang@link.cuhk.edu.cn
Description: Use the diffusion as the future image decoder.
'''
grad_max_norm = 35
print_freq = 10
max_epochs = 200
...
val_dataset_config = train_dataset_config   ## NOTE: ONLY for overfitting debug
...
model = dict(
    ...
    model_cfg=dict(
        ...
        encoder_cfg=dict(
            ...
            heads=8),
        decoder_cfg=dict(
            type='FutureImageConditionEmbedding',
            channel=3*2*2,
            model_channel=128,
            N=6, ## number of layers
            heads=8),
