...
Date: 2024-02-22 11:46:37
Email: haimingzhang@link.cuhk.edu.cn
Description: Train the occworld with multi-modal inputs and use
the cross attention mechanism to fuse the information from different modalities.
'''
grad_max_norm = 35
print_freq = 10
max_epochs = 200
