...
Date: 2024-03-28 23:55:52
Email: haimingzhang@link.cuhk.edu.cn
Description: Predict the absolute flow, and then transform to the future frames by using
the future ego-motion.
'''
grad_max_norm = 35
print_freq = 10
max_epochs = 200
...
n_e_ = 512
model = dict(
    type='XWorldPredictorWithBEVFlow',
    use_predictor=True,
    pred_abs_flow=True,
    model_cfg=dict(
