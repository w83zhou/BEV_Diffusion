...
class StableDiffusionBEVControlNetPipelineWM(StableDiffusionBEVControlNetPipeline):
    def __init__(
        self,
        vae: AutoencoderKL,
    ...
    def __call__(
        ...
        N_frame, N_cam = image.shape[1:3]

        f_to_b = partial(rearrange, pattern="b f ... -> (b f) ...")
        b_to_f = partial(rearrange, pattern="(b f) ... -> b f ...", f=N_frame)
