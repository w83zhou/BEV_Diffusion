...
class BEVControlNetModel(ModelMixin, ConfigMixin):
    ...
    def add_cam_states(self, encoder_hidden_states=None, camera_emb=None):
        """
        Args:
        ...
        if encoder_hidden_states is None:
            return cam_hidden_states.unsqueeze(2)
    ...
    def create_dummy_cam_states(self, bs, N_cam):
        cam_hidden_states = self.cam2token(self._embed_camera(
                self.uncond_cam_param([bs, N_cam])))
        
        cam_hidden_states = cam_hidden_states.unsqueeze(2)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # encoder_hidden_states_with_cam = self.create_dummy_cam_states(
